...
const formatText: any = {
    ...
    httpLogger: function (ctx: any) {
        let logText = new String();
        logText += "\n" + "*************** response log start 请求日志***************" + "\n"; //请求日志
        logText += "请求 response body: " + "\n" + JSON.stringify(ctx.body) + "\n";    //请求内容
...
export const logRequest = (info: any) => {    //封装普通日志
    if (info) {
        httpLogger.info(formatText.httpLogger(info));
    }
}
