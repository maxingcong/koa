...
log4js.configure({
    appenders: {
        ...
        allLog: {
            ...
            filename: 'logS/all',  //  '/logS/all' 与  logS/all   当前系统根目录 与当前项目目录
        ...
        httpLog: { type: "file", filename: "logS/http/Access.log", pattern: ".yyyy-MM-dd", keepFileExt: true },
        errorLog: { type: 'file', filename: 'logS/error/error.log', pattern: ".yyyy-MM-dd", keepFileExt: true },
...
export const httpLogger = log4js.connectLogger(httpLog, {
    level: 'ALL'
});
